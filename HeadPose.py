...
# def smooth_head_tilt_angle(current_angle):
#     global prev_head_tilt
#     smoothed_angle = alpha + current_angle + (1 - alpha) * prev_head_tilt
#     prev_head_tilt = smoothed_angle
...
def getHeadTiltAndCoords(size, image_points, frame_height):
    ...
    # smoothed_head_tilt = smooth_head_tilt_angle(head_tilt_degree)
    ...
    # return smoothed_head_tilt, starting_point, ending_point, ending_point_alternate
